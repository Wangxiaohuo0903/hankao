    ...
    func sd_setSVGImage(urlString: String?) {
        ...
        if urlString!.lowercased().hasSuffix(".svg") {
            ...
            let destination: DownloadRequest.DownloadFileDestination = { _, _ in
                ...
                documentsURL.appendPathComponent("test.svg")
            ...
            */
            ...
            let htmlString = "<html><head> <style type = \"text/css\">img{height:100%;width:auto;margin:0;}  </style> </head><body><img src = \"\(urlString!)\"></body></html>"
