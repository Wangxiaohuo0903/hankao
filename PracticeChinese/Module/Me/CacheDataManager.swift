...
//   var userRecordings:[LessonRecord]! = []
    ...
    func log(){
//        print("【islogin】:"+String(self.islogin))
//        print("【userId】:"+String(self.userId))
//        print("【userName】:"+String(self.userName))
//        print("【userAvatar】:")
//        print(self.userAvatar)
//        print("【LoginAccountType】:")
//        print(self.loginAccountType)
//        print("【userModel】:")
//        print(self.userModel.toJSON())
//        print("【userInfo】:")
//        print(self.userInfo.toJSON())
//        print("【userSummary】:")
//        print(self.userSummary.toJSON())
    }
