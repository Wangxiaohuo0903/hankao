...
- (UIView *)sesameCreditType {
    ...
    //进度
    _circle = [[MLMCircleView alloc] initWithFrame:CGRectMake(0, 0, self.width_s, self.height_s) startAngle:startAngle endAngle:endAngle];
...
- (UIView *)speedDialType {
    ...
    //刻度
    _calibra = [[MLMCalibrationView alloc] initWithFrame:CGRectMake(0, 0, self.width_s, self.height_s) startAngle:startAngle endAngle:endAngle];
    _calibra.textType = MLMCalibrationViewTextRotate;
